...
public class DAOTag {
    ...
    private static Tag getOrCreateTag(md.varoinform.controller.cache.Tag t, DefaultClosableSession session) {
    ...
    private static Tag createTag(md.varoinform.controller.cache.Tag t, DefaultClosableSession session) {
        Tag tag = new Tag();
        tag.setTitle(t.getTitle());
