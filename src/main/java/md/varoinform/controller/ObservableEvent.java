...
public class ObservableEvent {
    ...
    public static final int HISTORY_MOVE = 1;
    public static final int BACK_SET_ENABLE = 2;
    public static final int FORWARD_SET_ENABLE = 3;
    public static final int SEARCH_EVENT = 4;
